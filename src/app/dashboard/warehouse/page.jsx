  ...
  return (
    ...
    >
      <div className="space-y-6 p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              Manage GRNs, stock locations, storage conditions, and dispatch operations.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-md border border-black/[0.46] overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
            <div>
              <p className="text-xs font-semibold text-gray-700">GRN Inventory Register</p>
            ...
            <table className="w-full text-sm text-left">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">GRN No. / Date</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Warehouse / Location</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Bin / Stack / Shelf</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Commodity</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Accepted (kg)</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Receiving Officer</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">GRN Status</th>
                  <th className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-4 py-3">Stock Status</th>
