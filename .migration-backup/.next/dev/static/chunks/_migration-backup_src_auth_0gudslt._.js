...
"[project]/.migration-backup/src/auth/mockUsers.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.migration-backup/src/auth/authContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const login = (email, password)=>{
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockUsers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === email && u.password === password);
        if (foundUser) {
    ...
    const updateUser = (updates)=>{
        setUser((currentUser)=>{
            ...
            if (updates.password) {
                const persistedUser = __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockUsers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((entry)=>entry.id === nextUser.id || entry.email === nextUser.email);
                if (persistedUser) {
...
"[project]/.migration-backup/src/auth/mockNotifications.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.migration-backup/src/auth/notificationContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockNotifications$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/.migration-backup/src/auth/mockNotifications.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
function NotificationProvider({ children }) {
    _s();
    const [notifications, setNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockNotifications$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockNotifications"]);
...
_s(NotificationProvider, "nvwrGHLCJetL5/B0tX+lzGQcTFw=");
...
"[project]/.migration-backup/src/auth/mockRoles.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.migration-backup/src/auth/rbacContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function loadRoles() {
    ...
    /* ignore */ }
    return __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_ROLES"];
}
function RBACProvider({ children }) {
    _s();
    const [roles, setRoles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_ROLES"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RBACProvider.useEffect": ()=>{
    ...
    const resetPermissions = (id)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_PERMISSIONS"][id]) {
            updateRole(id, {
                permissions: __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_PERMISSIONS"][id]
            });
        } else if (__TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOBILE_PERMISSIONS"][id]) {
            updateRole(id, {
                mobilePermissions: __TURBOPACK__imported__module__$5b$project$5d2f2e$migration$2d$backup$2f$src$2f$auth$2f$mockRoles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOBILE_PERMISSIONS"][id]
            });
        }
    };
...
_s(RBACProvider, "Vn8PiW+oeh6oU+Fxq2rhVL/SXp4=");
_c = RBACProvider;
const useRBAC = ()=>{
    _s1();
...
_s1(useRBAC, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
//# sourceMappingURL=_migration-backup_src_auth_0gudslt._.js.map